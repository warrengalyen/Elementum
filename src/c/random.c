...
_Bool randomBool(void) { return randomU8() & 1; }

_Bool randEveryU8(U8 n) { return randomU8() % n == 0; }

_Bool randEveryU32(U32 n) { return randomU32() % n == 0; }

F32 randomF32(void) { return (randomU32() >> 8) * (1.0f / (1ul << 24)); }