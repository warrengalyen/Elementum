...
void VARPREF(update)(Element *el, Cell *cell, U16 x, U16 y) {
    ...
    switch (el->r0) {
        case 0:
            ...
            } else if (targetType == PISTON && targetLeft->el->r0 == 1)
                targetLeft->el->r0 = 2;
            break;
        case 1:
            if (el->rv >= 20)
        ...
        case 2:
            ...
            el->rv -= 1;
            if (targetType == PISTON && targetLeft->el->r0 == 1)
                targetLeft->el->r0 = 2;
    }
}
...
ElementInfo VARPOST(info) = {
        .attempt = VARPREF(attempt),
                             ...
                             .colors = {COLOR(0x3e463e), COLOR(0x313a31), COLOR(0x1f271f), COLOR(0x4a514a),

                                        COLOR(0x735c21), COLOR(0x5f4b16), COLOR(0x57471d), COLOR(0x625227)}};
